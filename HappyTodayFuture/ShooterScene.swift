...
class ShooterScene: SKScene {
    ...
    func initShooterScene () {
        ...
        for index in 1...shooterAtlas.textureNames.count {
            ...
            let imgName = String(format: "frame%01d", index)
            let texture: SKTexture = shooterAtlas.textureNamed(imgName);
            
            shooterAnimation += [texture]
        }
    ...
    override func touchesBegan(touches: Set<NSObject>, withEvent event: UIEvent) {
        ...
        if (shooterNode != nil) {
            ...
            let shootBullet = SKAction.runBlock({
                ...
                bulletNode.physicsBody?.applyImpulse(CGVectorMake(180.0, 50))
            })
    ...
    func createBulletNode() -> SKSpriteNode {
        ...
        bullet.position = CGPointMake(shooterPosition!.x + shooterWidth!/2, shooterPosition!.y + 70)
